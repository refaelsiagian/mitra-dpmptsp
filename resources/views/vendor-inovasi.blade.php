...
<div class="max-w-6xl mx-auto pb-10">
    ...
    <div class="relative bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-200 mb-8">
        ...
        <div class="h-48 md:h-64 w-full bg-slate-200 relative">
            <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Company Banner" class="w-full h-full object-cover opacity-90">
        ...
        <div class="absolute -bottom-8 md:-bottom-12 left-6 md:left-10 w-24 h-24 md:w-32 md:h-32 bg-white rounded-xl shadow-md border-4 border-white overflow-hidden flex items-center justify-center">
             <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-blue-600"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-3"/><path d="M9 9v.01"/><path d="M9 12v.01"/><path d="M9 15v.01"/><path d="M9 18v.01"/></svg>
        </div>
        ...
        <div class="flex-1 lg:w-2/3 space-y-8">
            ...
            <div>
                <div class="flex items-center gap-3 mb-2">
                    <h1 class="text-3xl font-bold text-slate-900">PT Inovasi Properti Mandiri</h1>
                ...
                <p class="text-slate-500 font-medium">Berdiri sejak 2015 • Konstruksi & Pengembangan Properti</p>
            </div>
            
            <!-- Proyek yang Ditawarkan Section -->
            <div class="bg-gradient-to-r from-blue-50/80 via-indigo-50/50 to-white p-6 rounded-2xl border-2 border-blue-200 shadow-sm relative overflow-hidden">
                <div class="flex items-center justify-between gap-4 mb-3">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-600 text-white text-xs font-bold shadow-2xs">
                        ...
                        Tender Resmi Ditawarkan
                    </span>
                    <span class="text-xs font-semibold text-emerald-700 bg-emerald-100 px-2.5 py-1 rounded-full">Ditutup dalam 5 Hari</span>
                </div>
                <h3 class="text-xl font-bold text-slate-900 mb-2">Pembangunan Gedung Kantor Tahap 2</h3>
                <p class="text-sm text-slate-600 mb-5">Proyek pembangunan struktur utama Gedung Kantor Tahap 2 yang berlokasi di area CBD Jakarta Selatan. Kontraktor terpilih bertanggung jawab atas pengadaan material dan konstruksi hingga lantai 15.</p>
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-blue-200/60">
                    <div>
                        <p class="text-xs text-slate-500 font-medium">Nilai Pagu Maksimal</p>
                        <p class="text-lg font-bold text-emerald-600">Rp 45.000.000.000</p>
                    </div>
                    <a href="/project/tender" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-colors shadow-md shadow-blue-500/20 text-sm inline-flex items-center justify-center gap-2">
                        Lihat Detail Proyek & Tender
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <p class="text-slate-600 leading-relaxed">
                    PT Inovasi Properti Mandiri adalah pengembang real estate dan manajemen properti komersial yang berfokus pada pembangunan kawasan perkantoran ramah lingkungan (green building) di Jabodetabek. Kami senantiasa bermitra dengan kontraktor dan penyedia jasa konstruksi terbaik untuk menghadirkan bangunan berstandar internasional.
                </p>
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-lg font-bold text-slate-900">Portofolio Proyek Properti</h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div class="group relative bg-slate-100 rounded-xl overflow-hidden aspect-[4/3] border border-slate-200 cursor-pointer">
                        <img src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Gedung Kantor Tahap 1" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                            <span class="text-white font-medium text-sm">Gedung Kantor CBD Tahap 1</span>
                        </div>
                    </div>
                    
                    <!-- Project 2 -->
                    <div class="group relative bg-slate-100 rounded-xl overflow-hidden aspect-[4/3] border border-slate-200 cursor-pointer">
                        <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Apartemen Green Living" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                            <span class="text-white font-medium text-sm">Apartemen Green Living</span>
                        </div>
                    </div>
                    
                    <!-- Project 3 -->
                    <div class="group relative bg-slate-100 rounded-xl overflow-hidden aspect-[4/3] border border-slate-200 cursor-pointer">
                        <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Kawasan Komersial" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                            <span class="text-white font-medium text-sm">Kawasan Komersial Serpong</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-slate-900 font-semibold font-mono">9120384710293</p>
                        </div>
                        <!-- PKP -->
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-slate-500 text-sm mt-0.5">Estimasi Revenue: > Rp 50 Miliar</p>
                        </div>
