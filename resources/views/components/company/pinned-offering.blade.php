...
<div class="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 md:p-8 text-white shadow-lg shadow-blue-900/20 relative overflow-hidden">
    ...
    <div class="relative z-10">
        ...
        <a wire:navigate href="{{ route('projects.show', $pinnedOffering->id) }}" class="inline-flex items-center gap-2 bg-white text-blue-700 hover:bg-blue-50 font-bold px-5 py-2.5 rounded-lg transition-colors text-sm shadow-sm">
            Lihat Detail Proyek
