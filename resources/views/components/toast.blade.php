...
<div id="js-global-toast" class="fixed top-6 left-1/2 -translate-x-1/2 z-[9999] w-max max-w-[90vw] sm:max-w-md bg-slate-800 border border-slate-700 text-white px-5 py-3.5 rounded-xl shadow-2xl flex items-center gap-3 transition-all duration-300 transform opacity-0 -translate-y-4 pointer-events-none">
