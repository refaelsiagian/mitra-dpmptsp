...
<div class="max-w-6xl mx-auto pb-10">
    ...
    <div class="relative bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-200 mb-8">
        ...
        <div class="h-48 md:h-64 w-full bg-slate-200 relative">
            <img src="https://images.unsplash.com/photo-1541888086425-d81bb19240f5?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Company Banner" class="w-full h-full object-cover opacity-90">
        ...
        <div class="absolute -bottom-8 md:-bottom-12 left-6 md:left-10 w-24 h-24 md:w-32 md:h-32 bg-white rounded-xl shadow-md border-4 border-white overflow-hidden flex items-center justify-center">
             <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-blue-500"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>
        </div>
        ...
        <div class="flex-1 lg:w-2/3 space-y-8">
            ...
            <div>
                <div class="flex items-center gap-3 mb-2">
                    <h1 class="text-3xl font-bold text-slate-900">CV Baja Nusantara</h1>
                ...
                <p class="text-slate-500 font-medium">Berdiri sejak 2012 • Konstruksi Logam & Fabrikasi</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <p class="text-slate-600 leading-relaxed">
                    CV Baja Nusantara adalah perusahaan fabrikasi logam dan konstruksi baja terkemuka di Sumatera Utara. Kami memiliki pengalaman lebih dari 10 tahun dalam menyediakan solusi struktural berkualitas tinggi untuk proyek komersial dan industri. Tim kami terdiri dari tenaga ahli bersertifikat yang berkomitmen pada ketepatan waktu, keselamatan kerja, dan standar kualitas internasional.
                </p>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div class="group relative bg-slate-100 rounded-xl overflow-hidden aspect-[4/3] border border-slate-200 cursor-pointer">
                        <img src="https://images.unsplash.com/photo-1503387762-592deb58ef4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Gudang Industri" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                            <span class="text-white font-medium text-sm">Pembangunan Gudang Industri</span>
                        </div>
                    </div>
                    
                    <!-- Project 2 -->
                    <div class="group relative bg-slate-100 rounded-xl overflow-hidden aspect-[4/3] border border-slate-200 cursor-pointer">
                        <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Struktur Baja Komersial" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                            <span class="text-white font-medium text-sm">Struktur Baja Mall</span>
                        </div>
                    </div>
                    
                    <!-- Project 3 -->
                    <div class="group relative bg-slate-100 rounded-xl overflow-hidden aspect-[4/3] border border-slate-200 cursor-pointer">
                        <img src="https://images.unsplash.com/photo-1504307651254-35680f356f58?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Konstruksi Jembatan" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                            <span class="text-white font-medium text-sm">Perakitan Jembatan Penyeberangan</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <p class="text-slate-900 font-semibold font-mono">1234567890123</p>
                                <button class="text-slate-400 hover:text-blue-600 transition-colors" title="Salin NIB">
                        ...
                        <div>
                            ...
                            <p class="text-slate-500 text-sm mt-0.5">Estimasi Revenue: > Rp 15 Miliar</p>
                        </div>
