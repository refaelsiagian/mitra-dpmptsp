        ...
        <div class="md:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <h1 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight leading-tight mb-4">
                    Kemitraan Suplai Kardus & Kemasan Ramah Lingkungan (MOQ Fleksibel)
                </h1>

                <!-- Initiator Company Info -->
                <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-100 mb-6">
                    <div class="w-10 h-10 rounded-lg bg-purple-600 flex items-center justify-center text-white font-bold text-base flex-shrink-0">
                        KK
                    </div>
                    <div>
                        <p class="text-xs text-slate-500 font-medium">Inisiator Suplai (Supply Side):</p>
                        <a href="/vendor/kreatif-kemasan" class="text-sm font-bold text-slate-800 hover:text-blue-600 flex items-center gap-1 transition-colors">
                            UD Kreatif Kemasan Abadi
                ...
                <div class="prose prose-slate max-w-none text-slate-600 space-y-4 text-sm leading-relaxed">
                    <h3 class="text-base font-bold text-slate-900 border-b border-slate-100 pb-2">Latar Belakang & Spesifikasi Produk</h3>
                    <p>
                        UD Kreatif Kemasan Abadi siap menjadi mitra suplai kemasan terpercaya bagi usaha kuliner, roastery kopi, dan bisnis oleh-oleh di Medan dan sekitarnya. Kami memproduksi boks makanan berbahan kertas kraft eco-friendly dan karton gelombang (corrugated box) dengan kualitas cetak sablon presisi.
                    </p>

                    <h3 class="text-base font-bold text-slate-900 border-b border-slate-100 pb-2 mt-6">Keunggulan Kemitraan Suplai</h3>
                    <ul class="list-disc pl-5 space-y-1">
                        <li><strong>Bahan Food Grade:</strong> Kertas tahan minyak dan tidak mengandung bahan kimia berbahaya bagi makanan.</li>
                        <li><strong>Desain Custom Gratis:</strong> Mitra mendapat fasilitas pembuatan desain layout dan pelat sablon gratis untuk kontrak minimal 6 bulan.</li>
                        <li><strong>MOQ Rendah & Pengiriman Rutin:</strong> Pengiriman dapat dijadwalkan per minggu sesuai kapasitas gudang penyimpan mitra.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="p-4 rounded-xl bg-slate-50 border border-slate-200/60">
                        ...
                        <span class="text-2xl font-black text-purple-700">Rp 2.500 <span class="text-sm font-normal text-slate-500">/ Pcs (Mulai dari)</span></span>
                        <p class="text-xs text-slate-500 mt-2">Harga bahan baku kertas dikunci selama masa kontrak, bebas dari kenaikan harga kertas global.</p>
                    </div>

                    <div class="p-4 rounded-xl bg-slate-50 border border-slate-200/60">
                        <span class="text-xs font-bold text-slate-400 uppercase tracking-wider block mb-1">Minimum Order Quantity (MOQ)</span>
                        <span class="text-xl font-bold text-slate-800">1.000 Pcs / Bulan</span>
                        <p class="text-xs text-slate-500 mt-2">MOQ yang sangat terjangkau untuk UKM, dapat diambil parsial 250 pcs per minggu.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm sticky top-6">
                ...
                <div class="space-y-4 text-sm mb-6">
                    <div>
                        ...
                        <span class="font-bold text-slate-800">Kontrak Suplai Kemasan & Box</span>
                    </div>
                    <div>
                        <span class="text-slate-400 text-xs block">Kisaran Harga</span>
                        <span class="font-bold text-purple-700">Rp 2.500 - 8.500 / Pcs</span>
                    </div>
                    <div>
                        <span class="text-slate-400 text-xs block">Minimum Order (MOQ)</span>
                        <span class="font-semibold text-slate-800">1.000 Pcs / Bulan</span>
                    </div>
                    <div>
                        <span class="text-slate-400 text-xs block">Bahan Baku</span>
                        <span class="font-semibold text-slate-800">Kraft Eco & Corrugated Karton</span>
                    </div>
                    <div>
                        <span class="text-slate-400 text-xs block">Waktu Produksi</span>
                        <span class="font-semibold text-slate-800">3 - 5 Hari Kerja per Batch</span>
                    </div>
                </div>

                <div class="umkm-only">
                    <button class="w-full py-3 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-bold text-sm rounded-xl shadow-sm transition-all flex items-center justify-center gap-2 mb-3">
                    <span>Minta Sampel Box & Katalog Harga</span>
                </button>
                </div>
                ...
                <button class="w-full py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs rounded-xl transition-colors flex items-center justify-center gap-2">
                    ...
                    <span>Konsultasi Desain Kemasan</span>
                </button>
            </div>
        </div>
