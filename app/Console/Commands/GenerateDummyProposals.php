...
class GenerateDummyProposals extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dummy:proposals';
     ...
     * @var string
     */
    protected $description = 'Generate dummy proposals for published projects';
    ...
    public function handle()
    {
                ...
                foreach ($selectedSenders as $sender) {
                    ...
                    if (!$exists) {
                        Proposal::create([
                            ...
                            'cover_letter' => "Halo,\n\nKami sangat tertarik dengan proyek/penawaran ini: {$project->title}. Kami memiliki pengalaman yang relevan dan kapasitas untuk memenuhi kebutuhan Anda.\n\n" . $faker->paragraph(3) . "\n\nTerima kasih.",
        ...
        $this->info("Berhasil membuat $createdCount proposal/ketertarikan dummy!");
    }
}
